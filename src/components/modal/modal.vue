<template>
	<view @touchmove.stop.prevent>
		<view class="tui-modal-box" :style="{width:width,padding:padding,borderRadius:radius,maxHeight:height,background: bg,left:left,top:top}"
		 :class="[(fadein || show)?'tui-modal-normal':'tui-modal-scale',show?'tui-modal-show':'']">
			<view v-if="!custom" style="position: relative;">
				<view class="close" @tap='close'>
					<text class="icon iconfont icon-icon-close" style="font-size: 40rpx;"></text>
				</view>
